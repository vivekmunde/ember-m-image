...
test('it sets the image attribute alt', function (assert) {
  ...
  this.render(hbs`{{m-image alt="one" imageSrc="./img/test.png" preloaderImageSrc="./img/preloader-1.gif" errorImageSrc="./img/error.png" class="m-image"}}`);
...
test('it displays the loading image', function (assert) {
  ...
  assert.equal(this.$('img').attr('src'), './img/preloader-1.gif', 'image src was set to loading image');
  assert.ok(this.$('img').attr('class').indexOf('loading') > -1, 'css-class loading was set');
});

// ----------------------------------------------------------------------------------------------------------

test('it displays the image', function (assert) {
  assert.expect(2);
...
test('it displays the error image', function (assert) {
  assert.expect(2);

  this.render(hbs`{{m-image alt="one" imageSrc="./img/non-existing-image.png" preloaderImageSrc="./img/preloader-1.gif" errorImageSrc="./img/error.png" class="m-image"}}`);
